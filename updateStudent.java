...
public class updateStudent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setFont(new java.awt.Font("Bodoni MT Condensed", 1, 36)); // NOI18N
        ...
        jLabel3.setText("Enter New Department");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String newPost=jTextField3.getText();
        int id=Integer.parseInt(ID);
        
        //search the id and pick 
        ManageStudent.c.updateStudent(id,newName,newPost);
